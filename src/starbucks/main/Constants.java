public class Constants {
    ...
    // grid
    public static final int CELL_WIDTH = 125;
    ...
    // card input
    public static final int CARD_INPUT_HEIGHT = 30;
    public static final int CARD_INPUT_TOP_PADDING = 22;
    // card number input
    public static final int CARD_NUM_MAX_LENGTH = 9;
